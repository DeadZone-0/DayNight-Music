package com.midnight.music.service;
...
public class MusicService extends Service {
    ...
    public static final String ACTION_PLAY_PAUSE = "com.midnight.music.ACTION_PLAY_PAUSE";
    public static final String ACTION_NEXT = "com.midnight.music.ACTION_NEXT";
    public static final String ACTION_PREVIOUS = "com.midnight.music.ACTION_PREVIOUS";
    public static final String ACTION_CLOSE = "com.midnight.music.ACTION_CLOSE";
    // Action to update the notification when song or state changes
    public static final String ACTION_UPDATE = "com.midnight.music.ACTION_UPDATE";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        if (intent != null && intent.getAction() != null) {
            ...
            // First start â€” show a notification immediately to satisfy foreground requirement
            showNotification();
        }
    ...
    private Notification buildNotification(Song song, boolean isPlaying, Bitmap albumArt) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, CHANNEL_ID)
                ...
                // Apply MediaStyle â€” show all 3 actions in compact view
